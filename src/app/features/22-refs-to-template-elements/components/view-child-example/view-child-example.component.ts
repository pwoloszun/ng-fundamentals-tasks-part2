...
export class ViewChildExampleComponent implements OnInit, AfterViewInit {
  ...
  // ng Component ref
  @ViewChild(PersonDetailsComponent, { static: false }) personComp: PersonDetailsComponent;
  @ViewChild('myTmplVariable', { static: false }) personComp2: PersonDetailsComponent;

  // list of ng Components
  @ViewChildren(PersonDetailsComponent) allPDC: QueryList<PersonDetailsComponent>;

  // DOM ref
  @ViewChild('myTmplVariable', { static: false, read: ElementRef }) pc2El: ElementRef;
