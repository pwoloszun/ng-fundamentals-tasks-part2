...
export class ContentChildExampleComponent implements OnInit, AfterContentInit {
  ...
  // component refs
  @ContentChild(PersonDetailsComponent, { static: false }) firstPD: PersonDetailsComponent;
  @ContentChild('thirdPD', { static: false }) myThirdPD: PersonDetailsComponent;
  @ContentChildren(PersonDetailsComponent) allPDs: QueryList<PersonDetailsComponent>;

  // DOM elements
  @ContentChild('secondHeader', { static: false, read: ElementRef }) secHeader: ElementRef;
